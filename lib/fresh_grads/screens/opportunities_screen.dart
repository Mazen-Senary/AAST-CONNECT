...
class _OpportunitiesScreenState extends State<OpportunitiesScreen> {
  ...
  static const List<String> _locationFilters = ['All', 'Remote', 'Hybrid', 'On-site'];

  List<JobOpportunity> get _filteredJobs {
    return AppData.opportunities.where((job) {
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () =>
                        setState(() => _showLocationFilter = !_showLocationFilter),
                    child: Container(
                      ...
                      children: _locationFilters.map((filter) {
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () =>
                                setState(() => _selectedLocation = filter),
