  ...
  Widget build(BuildContext context) {
              ...
              children: [
                Expanded(
                  child: StatCard(
                    ...
                    value: dashboard.isLoading ? '—' : dashboard.totalApplications.toString(),
                    change: dashboard.isLoading
        ? '—'
        : '${dashboard.totalAppsChange.toStringAsFixed(1)}%',
              ...
              Expanded(
                child: StatCard(
                  ...
                  value: dashboard.isLoading ? '—' : dashboard.pendingApplications.toString(),
                  change: dashboard.isLoading
    ? '—'
    : '${dashboard.pendingChange.toStringAsFixed(1)}%',
          ...
          StatCard(
            ...
            value: dashboard.isLoading ? '—' : dashboard.trainingUploads.toString(),
            change: dashboard.isLoading
    ? '—'
