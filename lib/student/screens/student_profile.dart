...
//   List<Map<String, dynamic>> _savedPrograms = []; // NEW
//
//   @override
//   void initState() {
//     super.initState();
...
//
//       // fetch saved programs with vacancy details
...
//         _savedPrograms = List<Map<String, dynamic>>.from(savedData); // NEW
//         _isLoading = false;
//       });
//     } catch (e) {
//       print('Error: $e');
...
class _StudentProfileState extends State<StudentProfile> {
  ...
  Future<void> _unsaveProgram(String vacancyId) async {
    try {
      ...
      // remove instantly from UI without full reload
      setState(() {
